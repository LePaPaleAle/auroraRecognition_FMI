...
def getTimeStamp(image, locationCoordinates, dateCoordinates, timeCoordinates):
    ...
    # Combine the strings to the final format MUONIO_YYYYMMDD_hhmmss
...
# (x_0, y_0, x_1, y_1) coordinates for MUONIO ASC location, date and time position in image
LOCATION_COORDINATES, DATE_COORDINATES, TIME_COORDINATES = (0, 0, 70, 30), (70, 0, 144, 32), (500, 0, 608, 32)

'''THESE PATHS MUST BE CHECKED WHEN SCRIPT IS MOVED TO ANOTHER LOCATION!!'''
AURORA_PATH = '/home/users/moisio/testing/MUO/aurora'
...
MASK_PATH = '/home/users/moisio/testing/MUO_mask.png'
TREE_MASK = Image.open(MASK_PATH)
AURORA, NO_AURORA = 1, 2
CAMERA_STATUS_PATH = '/home/users/moisio/testing/MUO/MUO_status.html'
VIDEO_PATHS = ['/arch/aurora/ASC/Color/MUO/movies/2022', '/arch/aurora/ASC/Color/MUO/movies/2022']
TEMP_NAME = '/home/users/moisio/testing/MUO/temp.jpg'
LATEST_IMAGE_NAME = '/home/users/moisio/testing/MUO/latest_MUO.png'
AURORA_THRESHOLD = 3500
...
try:
    ...
    handles = []
    if auroraPixelCount >= AURORA_THRESHOLD:
    ...
    run(['rsync', '--timeout=30',  '-avP', '/home/users/moisio/testing/MUO/latest_MUO.png',
        'moisio@astra.fmi.fi:/home/users/moisio/public_html/testing/MUO'])
    run(['rsync', '--timeout=30', '-avP', '/home/users/moisio/testing/MUO/MUO_status.html',
         'moisio@astra.fmi.fi:/home/users/moisio/public_html/testing/MUO'])
    ...
    exception_file = open('/home/users/moisio/testing/MUO/error_log.txt', 'a+')
    t = time.localtime()
